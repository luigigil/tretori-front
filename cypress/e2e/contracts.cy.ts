...
describe('Contracts Page', () => {
  ...
  it('should create a new contract', () => {
    ...
    cy.get('[name="copay"]').click()
    cy.get('[name="adhesion"]').click()
  ...
  it('should view an existing contract', () => {
    ...
    cy.get('[name="copay"]').should('have.checked', contractFixture.copay)
    cy.get('[name="adhesion"]').should('have.checked', contractFixture.adhesion)
  ...
  it('should edit a contract', () => {
    ...
    cy.get('[name="copay"]').click({ force: true })
    cy.get('[name="adhesion"]').click({ force: true })
